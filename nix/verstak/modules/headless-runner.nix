...
let
  ...
  codexAuthDependency = lib.optionals cfg.codex.enable [ "verstak-codex-auth.service" ];
  claudeAuthDependency = lib.optionals cfg.claude.enable [ "verstak-claude-auth.service" ];
